...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.player_index=0
        self.player_jump=pygame.image.load("images/jump.png")
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self,type):
        ...
        if type=="fly":
            ...
            #self.fly_surf=self.frames[self.fly_frame_index]
            y_pos=210
        else:
            ...
            #self.snail_surf = self.frames[self.snail_frame_index]
            y_pos = 300
...
# Snail
snail_frame_1 = pygame.image.load('images/snail1.png').convert_alpha()
snail_frame_2 = pygame.image.load('images/snail2.png').convert_alpha()
...
while True:
    ...
    if game_active:
        ...
        score_message=test_font.render(f"Your Score: {score}",False,(111,186,169))
